...
class InboxServer(smtpd.SMTPServer, object):
    ...
    def process_message(self, peer, mailfrom, rcpttos, data, **kw):
        ...
        log.debug(dict(to=rcpttos, sender=mailfrom, body=data, kw=kw))
        return None
        # return self._handler(to=rcpttos, sender=mailfrom, subject=subject, body=data, **kw)
